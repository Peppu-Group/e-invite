    ...
    <div id="app">
        ...
        <aside class="sidebar" :class="{ 'mobile-visible': mobileMenuOpen }">
            ...
            <div class="nav-section">
                ...
                <div class="nav-item active" @click="closeMobileMenu">
            ...
            <div class="nav-section">
                ...
                <div class="nav-item" @click="closeMobileMenu">
                    <span class="nav-item-icon">🌐</span>
                    <span>Event Website Builder</span>
            ...
            <div class="nav-section">
                <div class="nav-section-title">Launch</div>
                <div class="nav-item" @click="closeMobileMenu">
                    <span class="nav-item-icon">👁️</span>
                    <span>Preview</span>
                </div>
            ...
            <div class="nav-section">
                ...
                <div class="nav-item" @click="closeMobileMenu">
                    <span class="nav-item-icon">🤝</span>
                    <span>Invite Event Collaborator</span>
                </div>
                <div class="nav-item" @click="closeMobileMenu">
                    <span class="nav-item-icon">💺</span>
                    <span>Seating</span>
        ...
        <main class="main-content">
            ...
            <header class="header">
                ...
                <div class="header-actions">
                    ...
                    <button class="btn btn-outline"><span>👁️ Preview Event</span></button>
            ...
            <div class="content">
                <div class="page-header">
                    <h1 class="page-title">Event Checklist</h1>
                    <div class="progress-indicator">
                        <div class="progress-label">EVENT PROGRESS {{ eventScore }}%</div>
                        <div class="progress-bar">
                            <div class="progress-fill" :style="{ width: eventScore + '%' }"></div>
                        </div>
                    </div>
                </div>

                <div class="section-title">QUICK START</div>
                <h2 style="font-size: 28px; margin-bottom: 25px; font-weight: 600;">Customize</h2>

                <div class="checklist-cards">
                    <div class="checklist-card" v-for="item in checklistItems" :key="item.id">
                        <div class="card-icon icon-teal">{{ item.icon }}</div>
                        <div class="card-content">
                            <div class="card-title">
                                {{ item.title }}
                                <span class="optional-tag" v-if="item.optional">(optional)</span>
                            </div>
                            <div class="card-description">{{ item.description }}</div>
                            <div class="card-title">
                                Status:
                                <span class="optional-tag" v-if="this.event[item.title] === true">
                                    Completed
                                </span>

                                <span class="optional-tag" v-else>
                                    Not completed
                                </span>
                            </div>
                        </div>
...
export default {
        ...
        return {
            ...
            checklistItems: [
                ...
                },
                {
                    ...
                    icon: '💳',
                    title: 'Payment',
                    description: 'Collecting payments for your event? Create a payment account, or connect an existing account to process payments.',
                    optional: true
                },
                {
                    id: 5,
    ...
    mounted() {
        ...
        let event = this.events.find(item => item.id == id);
    ...
    computed: {
        eventScore() {
            const scoringFields = ['Website', 'Form', 'Invite', 'Payment', 'Confirmation'];

            return scoringFields.reduce((total, field) => {
                return total + (this.event[field] ? 20 : 0);
            }, 0);
        }
    },
    methods: {
